...
//    public Bitmap blurByRenderScript(Bitmap bmp) {
//        Bitmap result = Bitmap.createBitmap(bmp.getWidth(), bmp.getHeight(), Bitmap.Config.ARGB_8888);
//        RenderScript rs = RenderScript.create(UApplication.getInstance()); //创建RenderScript对象
...
//    }
    ...
    /**
     * 先缩放在进行模糊，然后再同比例放大，速度更快
     * @param originBitmap 原图
     * @param scaleRatio 缩放比例
     * @param blurRadius 模糊半径
     * @return
     */
    public static Bitmap blurByScale(Bitmap originBitmap,int scaleRatio,int blurRadius) {
        Bitmap scaledBitmap = Bitmap.createScaledBitmap(originBitmap,
                originBitmap.getWidth() / scaleRatio,
                originBitmap.getHeight() / scaleRatio,
                false);
        Bitmap blurBitmap = doBlur(scaledBitmap, blurRadius, true);
        Bitmap res = Bitmap.createScaledBitmap(blurBitmap, blurBitmap.getWidth() * scaleRatio, blurBitmap.getHeight() * scaleRatio, true);
